...
INDUSTRY_JOBS_INVALID_SUBCOMMAND = "Invalid subcommand, do `industry` to view valid subcommands."

INDUSTRY_JOBS_HELP_DESCRIPTION = "Gives information about industry jobs. Use `industry` to view this embed."
